	...
	public class XadesSignedXml : System.Security.Cryptography.Xml.SignedXml
	{
		...
		public void AddXadesObject(XadesObject xadesObject)
		{
			...
			if (this.SignatureStandard != KnownSignatureStandard.Xades)
			{
                ...
                reference.DigestMethod = "urn:ietf:params:xml:ns:cpxmlsec:algorithms:gostr34112012-256";//"http://www.w3.org/2001/04/xmldsig-more#gostr3411";
				...
				this.cachedXadesObjectDocument = new XmlDocument { PreserveWhitespace = false };
        ...
        private void BuildDigestedReferences()
        {
            ...
            Assembly System_Security_Assembly = Assembly.Load("System.Security, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a");//+		Assembly	{System.Security, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a}	System.Reflection.Assembly {System.Reflection.RuntimeAssembly}
            ...
            foreach (Reference reference2 in list2)
            {
               ...
               // XmlDocument xmldoc = new XmlDocument { PreserveWhitespace = false };
                //xmldoc.LoadXml(((System.Xml.XmlNode)m_containingDocument).OuterXml);
