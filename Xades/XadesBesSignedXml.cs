...
namespace Xades
{
    public class XadesBesSignedXml : XadesSignedXml
    {
        ...
        public void ComputeSignature(X509Certificate2 certificate, string privateKeyPassword)
        {
            ...
            SignedInfo.CanonicalizationMethod = XmlDsigExcC14NTransformUrl;// XmlDsigExcC14NTransformUrl;//XmlDsigCanonicalizationUrl;
            ...
            KeyInfo.Id = string.Format("xmldsig-{0}", Guid.NewGuid().ToString().ToLower());
